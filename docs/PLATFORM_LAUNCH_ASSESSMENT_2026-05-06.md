...
- As of 2026-06-02 (OCR-safe archived source-verifier metadata parity), `ENC-P0-019` tightens the archived source-verification JSON member itself:
  - `archive-ocr-safe-evidence --require-source-report-verification` now embeds archive-relative `archive_path` plus source-report archive path/SHA256/size metadata inside each archived source-verification JSON member.
  - `soenc transport verify-ocr-safe-evidence-archive` now fails closed if the archived verifier JSON member is malformed or if its own archive path or source-report archive metadata drifts from the manifest or archived source-report bytes.
  - Verification reports now expose `source_report_verification_archive_metadata_verified` for audit handoff.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_metadata_20260602/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_archive_metadata_verified=true`, `source_report_archive_metadata_parity_verified=true`, `verified_file_count=92`, `verified_total_size_bytes=385017`, `confusion_report_verified=true`, `source_report_verification_count=1`, `failure_count=0`, and archive SHA256 `118f259a863a9318437e72d020af1b5f7ec068b48bc4925204c65274f4af4e16`.
  - This tightens synthetic OCR-safe source-verifier archive provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-02 (OCR-safe correction-replay source-verifier archive-entry parity), `ENC-P0-019` extends the source-verifier archive metadata contract to correction replay evidence:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_verification_archive_entry_metadata_verified` for manifest-level source-verifier archive path/SHA256/size checks.
  - Correction-replay source-verification archives now get the same fail-closed archived verifier JSON source-report metadata checks as synthetic confusion evidence.
  - Local evidence `.tmp_transport_ocr_safe_correction_verifier_metadata_20260602/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `correction_replay_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=7`, `verified_total_size_bytes=104738`, `failure_count=0`, and archive SHA256 `de9d3f3f2acd3e73822447c712ffde2668d8b080486746424f089776e6e2b441`.
  - This tightens synthetic OCR-safe correction-replay archive provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-02 (OCR-safe source-verification manifest entry-set parity), `ENC-P0-019` tightens source-verification archive inventory determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_verification_manifest_entry_set_verified`.
  - OCR-safe archives now fail closed when `manifest.files[]` contains source-verifier or source-report archive records that are not referenced by a report-level `source_verification` or `source_report_archive` entry, even if the extra ZIP members and file metadata are self-consistent.
  - Local evidence `.tmp_transport_ocr_safe_entry_set_20260602/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_manifest_entry_set_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=383622`, `failure_count=0`, and archive SHA256 `38f9f9fa108c51ee51b94d30400f45bca703fc73be4ae277b0e28da1f01874c8`.
  - This tightens synthetic OCR-safe source-verification archive inventory provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-02 (OCR-safe rewritten report manifest entry-set parity), `ENC-P0-019` tightens rewritten report archive inventory determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_report_manifest_entry_set_verified`.
  - OCR-safe archives now fail closed when `manifest.files[]` contains rewritten report archive records that are not referenced by `manifest.reports[]`, even if the extra ZIP member and file metadata are self-consistent.
  - Local evidence `.tmp_transport_ocr_safe_report_entry_set_20260602/ocr_safe_evidence_archive_verification.json` verified `archive_report_manifest_entry_set_verified=true`, `archive_report_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384273`, `failure_count=0`, and archive SHA256 `a5df0f2feaef779cc60dd607e6a5fd0ffe126e5ebe511b17552633ee9c11cfa2`.
  - This tightens synthetic OCR-safe rewritten report archive inventory provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-02 (OCR-safe rewritten report file metadata parity), `ENC-P0-019` tightens rewritten report archive metadata determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now treats rewritten report file-entry role/SHA256/byte-size mismatches as failed `archive_report_metadata_verified`, not only as generic failures.
  - Embedded report replay remains visible when metadata drifts, so audit output can distinguish report replay success from archive-level provenance failure.
  - Local evidence `.tmp_transport_ocr_safe_rewritten_report_metadata_20260602/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, `archive_report_manifest_entry_set_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385110`, `failure_count=0`, and archive SHA256 `7667a626f26d07937b30b21ccb5ff42515660546e9a56cbb48ad553dc9518143`.
  - This tightens synthetic OCR-safe rewritten report archive metadata provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe file payload metadata parity), `ENC-P0-019` tightens manifest file-member payload determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now marks `manifest_file_metadata_verified=false` when any archive member bytes drift from that member's `manifest.files[]` SHA256 or byte-size metadata.
  - This catches payload tampering even when an external manifest envelope is updated to the tampered ZIP and the embedded manifest SHA itself remains valid.
  - Local evidence `.tmp_transport_ocr_safe_file_payload_metadata_20260603/ocr_safe_evidence_archive_verification.json` verified `manifest_file_metadata_verified=true`, `external_manifest_verified=true`, `archive_report_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384740`, `failure_count=0`, and archive SHA256 `96d6e082417c315a14b544510440c75ceb113ea4858d3ce7db9a363ff5ec7f2d`.
  - This tightens synthetic OCR-safe archive file payload metadata provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe source-report archive-entry metadata parity), `ENC-P0-019` tightens archived source-report file-entry determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_archive_entry_metadata_verified` for source-report archive file-entry role/SHA256/byte-size checks.
  - Source-report archive file-record missing, role mismatch, SHA256 mismatch, byte-size mismatch, member missing, or unreferenced source-report records now fail that dedicated gate instead of relying only on generic archive failures.
  - Local evidence `.tmp_transport_ocr_safe_source_report_entry_metadata_20260603/ocr_safe_evidence_archive_verification.json` verified `source_report_archive_entry_metadata_verified=true`, `source_report_archive_metadata_parity_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385391`, `failure_count=0`, and archive SHA256 `5d8ebf010df9d6ec6fa0596f381b7656cd75c5f2f7cef6bac03d0eae0498a653`.
  - This tightens synthetic OCR-safe source-report archive provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe source-report role ownership gate), `ENC-P0-019` tightens archived source-report role provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_archive_roles_verified`.
  - Source-report file records must exist under the expected source-report role for the owning report role; wrong-role ownership fails even when the ZIP member bytes and manifest summary role counters are otherwise self-consistent.
  - As of 2026-06-05, the same gate also covers report-level `source_report_archive.role` metadata; nested role drift fails with `source_report_archive_metadata_role_mismatch` even when the source-report archive file record and ZIP bytes remain correct.
  - Local evidence `.tmp_transport_ocr_safe_source_report_roles_20260604/ocr_safe_evidence_archive_verification.json` verified `source_report_archive_roles_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_archive_metadata_parity_verified=true`, `source_report_verification_roles_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384563`, `failure_count=0`, and archive SHA256 `05c17f4438c23b9d02ed847aa617024528abda16de173ec42794020f4f4a1f67`.
  - Local evidence `.tmp_transport_ocr_safe_source_report_nested_role_20260605/ocr_safe_evidence_archive_verification.json` verified `source_report_archive_roles_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_archive_metadata_parity_verified=true`, `source_report_verification_report_binding_verified=true`, `source_report_verification_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385103`, `failure_count=0`, and archive SHA256 `c74d2b10b79b0e5eeee1cb2fe47dfa8373db35a89cef57e65c6ada2e2c1348a5`.
  - This tightens synthetic OCR-safe source-report role ownership only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe source-report member byte parity), `ENC-P0-019` tightens archived source-report byte binding:
  - `soenc transport verify-ocr-safe-evidence-archive` now also marks `source_report_archive_metadata_parity_verified=false` and `archive_report_metadata_verified=false` when the archived source-report member bytes drift from `manifest.reports[].source_sha256`, even if source-report file-entry metadata and duplicated source-verification metadata are updated to match the tampered bytes.
  - Local evidence `.tmp_transport_ocr_safe_source_report_member_bytes_20260603/ocr_safe_evidence_archive_verification.json` verified `source_report_archive_metadata_parity_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `archive_report_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385205`, `failure_count=0`, and archive SHA256 `6f3a96562b89660b2578b211ab719beab1f8fe5b8b0e77d409e97c9eaa4efbde`.
  - This tightens synthetic OCR-safe source-report byte provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe archive inventory gate), `ENC-P0-019` tightens ZIP/member inventory determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_inventory_verified`.
  - Duplicate ZIP members, unsafe ZIP member paths, symlink members, unreadable archives, missing embedded manifests, unsafe manifest file paths, duplicate `manifest.files[].archive_path` values, missing archive members, and unexpected archive members now fail that stable inventory gate while embedded synthetic report replay remains separately visible.
  - Local evidence `.tmp_transport_ocr_safe_archive_inventory_20260603/ocr_safe_evidence_archive_verification.json` verified `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `archive_report_metadata_verified=true`, `archive_report_manifest_entry_set_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384368`, `failure_count=0`, and archive SHA256 `512bf2b7cb0f725bdd586fc1beabf8723000ed9aed365a06b718c14a8faf5216`.
  - This tightens synthetic OCR-safe archive inventory provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe fixed archive-member package guard), `ENC-P0-019` tightens archive creation determinism:
  - `soenc transport archive-ocr-safe-evidence` now reserves fixed members for rewritten reports and archived source-verifier JSON before writing the ZIP.
  - A collision with `synthetic_ocr_confusion_report.json`, `transport_ocr_correction_replay_report.json`, `synthetic_ocr_confusion_source_verification.json`, or `transport_ocr_correction_replay_source_verification.json` fails before archive creation instead of producing duplicate ZIP members.
  - Local evidence `.tmp_transport_ocr_safe_fixed_member_collision_20260603/ocr_safe_evidence_archive_verification.json` verified `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `archive_report_metadata_verified=true`, `archive_report_manifest_entry_set_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384833`, `failure_count=0`, and archive SHA256 `23aa6786d0b03cc21ca52fea60a0963152c5261611f1302b244bf531ed124972`.
  - This tightens synthetic OCR-safe archive package-time collision hygiene only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe source-report rewrite parity), `ENC-P0-019` tightens archive replay provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_report_source_rewrite_verified`.
  - The verifier reconstructs the deterministic archive-path rewrite from the archived source report and archive manifest source-path map, then fails closed if the archived rewritten report bytes drift while metadata and embedded report replay still pass.
  - Local evidence `.tmp_transport_ocr_safe_source_rewrite_20260603/ocr_safe_evidence_archive_verification.json` verified `archive_report_source_rewrite_verified=true`, `archive_report_metadata_verified=true`, `archive_report_manifest_entry_set_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384089`, `failure_count=0`, and archive SHA256 `7fb930916a7b3a91d24f9bab8c38835329f55e1b594623973a13de08f1ae7d0c`.
  - This tightens synthetic OCR-safe source-report to rewritten-report archive parity only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe archived-report path role binding), `ENC-P0-019` tightens archive replay path provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now requires replay-critical paths inside archived reports to point at manifest-declared archive members with the expected file role.
  - The verifier fails closed with `archived_report_path_role_mismatch` when a report field such as `ocr_input_path`, `source_page_texts[].path`, `manifest_path`, `payload_file`, `corrections_file`, or output paths references an existing ZIP member whose manifest role belongs to a different artifact class.
  - Local evidence `.tmp_transport_ocr_safe_report_path_roles_20260603/ocr_safe_evidence_archive_verification.json` verified `archived_report_paths_verified=true`, `archived_report_path_binding_count=89`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384368`, `failure_count=0`, and archive SHA256 `61f3e949c83915a1c8de24255937aacae9c44f32333e1dc2b79f9b87cccf0748`.
  - This tightens synthetic OCR-safe archived-report path role binding only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-03 (OCR-safe fixed archive-member path parity), `ENC-P0-019` tightens archive report-member determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_report_fixed_paths_verified` and `source_report_verification_fixed_paths_verified`.
  - Report-level rewritten reports and archived source-verifier JSON members must remain at their canonical fixed archive paths; relocation to same-role alternate members fails closed even if file records, summary metadata, and ZIP inventory are updated self-consistently.
  - Local evidence `.tmp_transport_ocr_safe_fixed_paths_20260603/ocr_safe_evidence_archive_verification.json` verified `archive_report_fixed_paths_verified=true`, `source_report_verification_fixed_paths_verified=true`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `archive_report_metadata_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=383810`, `failure_count=0`, and archive SHA256 `1344340241a41dda1bddda013c951fe40dead4bee0e31afc08459a737d8074b8`.
  - This tightens synthetic OCR-safe fixed-member path provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe requested-output path binding), `ENC-P0-019` tightens archived correction replay path hygiene:
  - `soenc transport archive-ocr-safe-evidence` now clears `requested_output_file` from archived failed/suppressed correction replay reports when no output artifact was packaged.
  - `soenc transport verify-ocr-safe-evidence-archive` now treats any present `requested_output_file` as replay-critical and requires it to be a safe archive-relative member with role `correction_recovered_output`.
  - Local evidence `.tmp_transport_ocr_safe_requested_output_path_20260604/ocr_safe_evidence_archive_verification.json` verified `archived_report_paths_verified=true`, `correction_replay_report_verified=true`, `verified_file_count=4`, `verified_total_size_bytes=99965`, `failure_count=0`, and archive SHA256 `56e480bfe68a9e8c37860dd85d342a678fc88510e25cc3cda4a074f60bdd7269`.
  - This tightens synthetic correction replay archive provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe archive source-path identity gate), `ENC-P0-019` tightens manifest source-path determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_source_paths_verified`.
  - Source-backed `manifest.files[]` records must have string, non-empty, unique `source_path` identities; fixed generated archive members must not carry a source path.
  - Duplicate, missing, unexpected, or non-string source-path metadata fails the archive before deterministic source-report rewrite parity can silently choose a replacement record.
  - Local evidence `.tmp_transport_ocr_safe_source_paths_20260604/ocr_safe_evidence_archive_verification.json` verified `archive_source_paths_verified=true`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=383912`, `failure_count=0`, and archive SHA256 `920e67229d8c319abae93d6e9ab51dc0e6ab07d5f9450b949f29ab54b7852274`.
  - This tightens synthetic OCR-safe archive manifest provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe report source-path provenance gate), `ENC-P0-019` tightens report-level source identity binding:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_report_source_paths_verified`.
  - Report-level `manifest.reports[].source_path` must be a non-empty string and, when source verification is required, must match the corresponding archived source-report file record identity.
  - This prevents a self-consistent archive from preserving source-report bytes and embedded replay while drifting the report provenance pointer to a different operator-local path.
  - Local evidence `.tmp_transport_ocr_safe_report_source_paths_20260604/ocr_safe_evidence_archive_verification.json` verified `archive_report_source_paths_verified=true`, `archive_report_metadata_verified=true`, `archive_source_paths_verified=true`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384563`, `failure_count=0`, and archive SHA256 `ad63df5326afa222c5459a02a49a46b8441b51974040df84feeed93e058d7720`.
  - This tightens synthetic OCR-safe archive report provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe report-role uniqueness gate), `ENC-P0-019` tightens report inventory determinism:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_report_roles_verified`.
  - `manifest.reports[]` must be a list of known, unique report roles; malformed report inventories, duplicate roles, and unknown roles fail the report metadata gate even if summary report counters are edited to match the tampered inventory.
  - Local evidence `.tmp_transport_ocr_safe_report_roles_20260604/ocr_safe_evidence_archive_verification.json` verified `archive_report_roles_verified=true`, `archive_report_metadata_verified=true`, `summary_report_count_verified=true`, `summary_report_roles_verified=true`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384913`, `failure_count=0`, and archive SHA256 `d3c1cbd8afc019913b73f3b97f988e35ab081e80791d13403b47ae37210990e7`.
  - This tightens synthetic OCR-safe archive report-role replay integrity only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe report-schema binding gate), `ENC-P0-019` tightens report schema provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `archive_report_schemas_verified`.
  - `manifest.reports[]` role/schema pairs must match the expected report schema, and embedded rewritten report JSON must also prove the expected schema; mismatch, unreadable JSON, and non-object report JSON fail the report metadata gate.
  - Local evidence `.tmp_transport_ocr_safe_report_schemas_20260604/ocr_safe_evidence_archive_verification.json` verified `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `archive_report_metadata_verified=true`, `summary_report_count_verified=true`, `summary_report_roles_verified=true`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `archive_file_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384098`, `failure_count=0`, and archive SHA256 `e67b0432a5d657c3e7b82c94362ac56ab1125a4bc5ee1f618e27a9663a1e7c06`.
  - This tightens synthetic OCR-safe archive report schema/role binding only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe source-verifier schema binding gate), `ENC-P0-019` tightens archived source-verifier schema provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_verification_schemas_verified`.
  - Report-level and archived source-verification JSON must use the expected verifier schema for the report role; schema drift fails source-verification schema/state gates even when archive member digests and file metadata are updated self-consistently.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_schema_20260604/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_schemas_verified=true`, `source_report_verification_states_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384842`, `failure_count=0`, and archive SHA256 `6f859baa51d3f131b01f126a385f44c645a23245039ddfcd4fd3842178e30454`.
  - This tightens synthetic OCR-safe source-verifier schema binding only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-04 (OCR-safe source-verifier role ownership gate), `ENC-P0-019` tightens archived source-verifier role provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_verification_roles_verified`.
  - Source-verifier file records must exist under the expected source-verifier role for the owning report role; wrong-role ownership fails even when the ZIP member bytes and manifest summary role counters are otherwise self-consistent.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_roles_20260604/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_roles_verified=true`, `source_report_verification_schemas_verified=true`, `source_report_verification_states_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_manifest_entry_set_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384749`, `failure_count=0`, and archive SHA256 `a112dafff1ab4054b39deaa3a64247c011af005b939710a15e2d635e0c813685`.
  - This tightens synthetic OCR-safe source-verifier role ownership only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-05 (OCR-safe source-verifier nested role gate), `ENC-P0-019` tightens report-level source-verifier role provenance:
  - `archive-ocr-safe-evidence` now writes `manifest.reports[].source_verification.role` with the expected archived source-verifier role.
  - `verify-ocr-safe-evidence-archive` applies `source_report_verification_roles_verified` to that nested role metadata and fails closed with `source_report_verification_metadata_role_mismatch` when it drifts, even if ZIP bytes, the source-verifier file record, and manifest summary role counters remain coherent.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_nested_role_20260605/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_roles_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_report_binding_verified=true`, `archive_report_metadata_verified=true`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `summary_roles_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385289`, `failure_count=0`, and archive SHA256 `a513fe06ec17d976150d7d625a91ed19de294e75fed827f35b01aeb62488604f`.
  - This tightens synthetic OCR-safe source-verifier nested role metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-05 (OCR-safe source-verifier report binding gate), `ENC-P0-019` tightens archived source-verifier report binding:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_verification_report_binding_verified`.
  - Manifest-level and archived source-verifier JSON must bind `report_sha256` and `report_file` to the owning archived source-report member; drift fails even when ZIP inventory, manifest file metadata, source-verifier archive-entry metadata, and embedded report replay are otherwise self-consistent.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_report_binding_20260605/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_report_binding_verified=true`, `source_report_verification_schemas_verified=true`, `source_report_verification_roles_verified=true`, `source_report_archive_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385568`, `failure_count=0`, and archive SHA256 `4f849c04fb6118bf76ed9c01124c3516ebf12b6620cae592fc7d2783ecede577`.
  - This tightens synthetic OCR-safe source-verifier report binding only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-05 (OCR-safe source-verifier archive-entry aggregate metadata gate), `ENC-P0-019` tightens aggregate OCR-safe archive metadata gating:
  - `soenc transport verify-ocr-safe-evidence-archive` now marks `archive_report_metadata_verified=false` when source-verifier archive-entry file records or ZIP members drift, including missing source-verifier file records or members, SHA256/byte-size mismatches, wrong source-verifier file roles, and unreferenced source-verifier records.
  - The dedicated `source_report_verification_archive_entry_metadata_verified` gate remains the specific diagnostic field, but aggregate report metadata now also fails for replay-critical source-verifier archive-entry drift.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_entry_gate_20260605/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_report_binding_verified=true`, `source_report_verification_roles_verified=true`, `source_report_archive_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385196`, `failure_count=0`, and archive SHA256 `5d5b3fd5409794c4d4b716e6601cc062817f15d2911735024836c37eccc797ce`.
  - This tightens synthetic OCR-safe source-verifier archive-entry aggregate metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-05 (OCR-safe source-report archive-entry aggregate metadata gate), `ENC-P0-019` tightens aggregate OCR-safe archive metadata gating:
  - `soenc transport verify-ocr-safe-evidence-archive` now marks `archive_report_metadata_verified=false` when archived original source-report file records or ZIP members drift, including missing source-report file records or members, SHA256/byte-size mismatches, wrong source-report file roles, and unreferenced source-report records.
  - The dedicated `source_report_archive_entry_metadata_verified` and `source_report_archive_roles_verified` gates remain the specific diagnostic fields, but aggregate report metadata now also fails for replay-critical source-report archive-entry drift.
  - Local evidence `.tmp_transport_ocr_safe_source_report_entry_gate_20260605/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_archive_metadata_parity_verified=true`, `source_report_archive_roles_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385010`, `failure_count=0`, and archive SHA256 `6e8467e7acac5fcf2158ddeb6d539517119eead32852b57b5337ab69dda1c6bd`.
  - This tightens synthetic OCR-safe source-report archive-entry aggregate metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-05 (OCR-safe rewritten report member role gate), `ENC-P0-019` tightens archived rewritten-report role provenance:
  - `archive-ocr-safe-evidence` now writes an expected fixed archive role into each archived rewritten report JSON member, such as `ocr_safe_confusion_report_rewritten`.
  - `verify-ocr-safe-evidence-archive` applies `archive_report_roles_verified` to that archived member role and fails closed with `archive_report_member_role_mismatch` when it drifts, even if report-level SHA256/size metadata, file records, ZIP bytes, and manifest summary counters are otherwise self-consistent.
  - Source-report-to-rewritten-report parity now includes that deterministic member role stamp before `archive_report_source_rewrite_verified=true`.
  - Local evidence `.tmp_transport_ocr_safe_report_member_role_20260605/ocr_safe_evidence_archive_verification.json` verified `archive_report_roles_verified=true`, `archive_report_metadata_verified=true`, `archive_report_source_rewrite_verified=true`, `archive_inventory_verified=true`, `manifest_file_metadata_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=384560`, `failure_count=0`, and archive SHA256 `20a554ffbcdbd7f1a242dfa3fe6460919d2630789c3635b3c6580edc5e84788a`.
  - This tightens synthetic OCR-safe rewritten-report member role provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-05 (OCR-safe source-report member state gate), `ENC-P0-019` tightens archived original source-report member provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_archive_member_state_verified`.
  - Archived original source-report JSON members must parse as objects, keep the expected schema for their owning report role, and keep boolean `success` parity with `manifest.reports[]`; schema/state drift fails aggregate `archive_report_metadata_verified` even if source-report file metadata, source-verifier archive metadata, and summary counters are recomputed.
  - Local evidence `.tmp_transport_ocr_safe_source_report_member_state_20260605/ocr_safe_evidence_archive_verification.json` verified `source_report_archive_member_state_verified=true`, `archive_report_metadata_verified=true`, `archive_report_source_rewrite_verified=true`, `source_report_archive_entry_metadata_verified=true`, `source_report_archive_metadata_parity_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_report_binding_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385304`, `failure_count=0`, and archive SHA256 `1a9a7ead043212afffa52fea0b0e01f94077210518e8ad4d98102c7b1deebbfd`.
  - This tightens synthetic OCR-safe source-report member schema/state provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-06 (OCR-safe source-verifier member state gate), `ENC-P0-019` tightens archived source-verifier member provenance:
  - `soenc transport verify-ocr-safe-evidence-archive` now exposes `source_report_verification_member_state_verified`.
  - Archived source-verification JSON members must parse as objects, keep the expected verifier schema for their owning report role, and keep `success`/`failure_count` parity with `manifest.reports[].source_verification`; schema/state drift fails aggregate `archive_report_metadata_verified` even if source-verifier file metadata and summary counters are recomputed.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_member_state_20260606/ocr_safe_evidence_archive_verification.json` verified `source_report_verification_member_state_verified=true`, `archive_report_metadata_verified=true`, `source_report_verification_archive_entry_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_report_binding_verified=true`, `source_report_verification_roles_verified=true`, `source_report_archive_member_state_verified=true`, `source_report_archive_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385490`, `failure_count=0`, and archive SHA256 `006fba179a232af4a915641a1459a76f48a083fb3ac7217f0d6e6043705552eb`.
  - This tightens synthetic OCR-safe source-verifier member schema/state provenance only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-06 (OCR-safe source-verifier binding aggregate gate), `ENC-P0-019` tightens aggregate OCR-safe archive metadata gating:
  - Archived source-verification JSON member drift in `report_sha256`, archive-relative `report_file`, `archive_path`, or `source_report_archive_*` now fails aggregate `archive_report_metadata_verified=false`.
  - The dedicated `source_report_verification_report_binding_verified` and `source_report_verification_archive_metadata_verified` gates remain the specific diagnostics, but aggregate archive-report metadata now also fails for replay-critical source-verifier binding drift.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_binding_20260606/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_report_binding_verified=true`, `source_report_verification_member_state_verified=true`, `source_report_archive_member_state_verified=true`, `source_report_archive_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385025`, `failure_count=0`, and archive SHA256 `fd236b46a7802fcc763280703e66c675ade7700d38f4946f4bb12e54f578c4cb`.
  - This tightens synthetic OCR-safe source-verifier binding aggregate metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-06 (OCR-safe source-verifier manifest-state aggregate gate), `ENC-P0-019` tightens aggregate OCR-safe archive metadata gating:
  - Manifest-level `source_verification_required`, `source_verification.schema`, `source_verification.success`, `source_verification.failure_count`, and `source_verification.report_sha256` drift now fails aggregate `archive_report_metadata_verified=false`.
  - The dedicated `source_report_verification_schemas_verified`, `source_report_verification_states_verified`, and `source_report_verification_report_binding_verified` gates remain the specific diagnostics, but aggregate archive-report metadata now also fails for replay-critical report-level source-verifier envelope drift.
  - Local evidence `.tmp_transport_ocr_safe_source_verifier_manifest_rollup_20260606/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, `source_report_verification_schemas_verified=true`, `source_report_verification_states_verified=true`, `source_report_verification_report_binding_verified=true`, `source_report_verification_archive_metadata_verified=true`, `source_report_verification_member_state_verified=true`, `source_report_archive_member_state_verified=true`, `source_report_archive_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `source_report_verification_count=1`, `verified_file_count=92`, `verified_total_size_bytes=385769`, `failure_count=0`, and archive SHA256 `7ba606e9eb5ebd5c361caae61e9f946b7df047d0cbaa6f3d9580899fcfdbecff`.
  - This tightens synthetic OCR-safe manifest-level source-verifier aggregate metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-06 (OCR-safe source-verification summary aggregate gate), `ENC-P0-019` tightens aggregate OCR-safe archive metadata gating:
  - Manifest summary source-verification inventory drift in `summary.source_report_verification_count` or `summary.source_report_verification_roles` now fails aggregate `archive_report_metadata_verified=false`.
  - The dedicated `summary_source_report_verification_count_verified` and `summary_source_report_verification_roles_verified` gates remain the specific diagnostics, but aggregate archive-report metadata now also fails for verifier-inventory summary drift.
  - Local evidence `.tmp_transport_ocr_safe_source_verification_summary_rollup_20260606/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, `summary_source_report_verification_count_verified=true`, `summary_source_report_verification_roles_verified=true`, `source_report_verification_count=1`, `source_report_verification_member_state_verified=true`, `source_report_verification_schemas_verified=true`, `source_report_verification_states_verified=true`, `source_report_verification_report_binding_verified=true`, `source_report_verification_roles_verified=true`, `source_report_archive_member_state_verified=true`, `archive_report_schemas_verified=true`, `archive_report_roles_verified=true`, `archive_report_source_rewrite_verified=true`, `confusion_report_verified=true`, `verified_file_count=92`, `verified_total_size_bytes=386048`, `failure_count=0`, and archive SHA256 `f0b256beb2ffdc501cf86341e3bb89bf71cc67d1ea8c8673da50cf1bb0cfc724`.
  - This tightens synthetic OCR-safe source-verification summary aggregate metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-06 (OCR-safe rewritten-report state aggregate gate), `ENC-P0-019` tightens aggregate OCR-safe archive metadata gating:
  - Manifest-level report `success` type drift and archived rewritten-report JSON `success` type/parity drift now fail aggregate `archive_report_metadata_verified=false`.
  - The dedicated `archive_report_states_verified` gate remains the specific diagnostic, but aggregate archive-report metadata now also fails for replay-critical report state drift.
  - Local evidence `.tmp_transport_ocr_safe_report_state_rollup_20260606/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, `archive_report_states_verified=true`, `archive_report_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_source_rewrite_verified=true`, `source_report_verification_count=1`, `confusion_report_verified=true`, `verified_file_count=92`, `verified_total_size_bytes=384653`, `failure_count=0`, and archive SHA256 `06d7a64e0be1af6eb05a16519bbc0e699fb1760e91bbdc381a04c6cc5fe2145d`.
  - This tightens synthetic OCR-safe rewritten-report state aggregate metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
- As of 2026-06-06 (OCR-safe manifest summary aggregate rollup), `ENC-P0-019` tightens aggregate OCR-safe archive metadata gating:
  - Replay-critical manifest summary drift in `summary.report_count`, `summary.report_roles`, `summary.file_count`, `summary.total_size_bytes`, or `summary.roles` now fails aggregate `archive_report_metadata_verified=false`.
  - The dedicated summary diagnostics remain the specific gates: `summary_report_count_verified`, `summary_report_roles_verified`, `summary_file_count_verified`, `summary_total_size_verified`, and `summary_roles_verified`.
  - Local evidence `.tmp_transport_ocr_safe_summary_rollup_20260606/ocr_safe_evidence_archive_verification.json` verified `archive_report_metadata_verified=true`, all report/file/role/source-verification summary gates true, `archive_report_states_verified=true`, `archive_report_roles_verified=true`, `archive_report_schemas_verified=true`, `archive_report_source_rewrite_verified=true`, `source_report_verification_count=1`, `confusion_report_verified=true`, `verified_file_count=92`, `verified_total_size_bytes=384188`, `failure_count=0`, and archive SHA256 `994285b91a8269fa13a1774b45bb7e4e12a0884320a831b2fa2a81e3df043879`.
  - This tightens synthetic OCR-safe manifest summary aggregate metadata only; it still does not certify real camera/photo, physical print-scan, or backend-specific OCR transfer.
